...
{
    FILE * read_iq_i_file = fopen("./src/txt_files/read_iq_i_cmp.txt", "w");
    FILE * read_iq_q_file = fopen("./src/txt_files/read_iq_q_cmp.txt", "w");
...
void demodulate_n( int *real, int *imag, int *real_prev, int *imag_prev, const int n_samples, const int gain, int *demod_out )
{
    ...
    FILE * demodulate_file = fopen("./src/txt_files/demodulate_cmp.txt", "w");
                  ...
                  int *x_real, int *x_imag, const int taps, const int decimation, int *y_real_out, int *y_imag_out ) 
{
    ...
    FILE * fir_cmplx_real_out_file = fopen("./src/txt_files/fir_cmplx_real_cmp.txt", "w");
    FILE * fir_cmplx_imag_out_file = fopen("./src/txt_files/fir_cmplx_imag_cmp.txt", "w");
...
{
    FILE * add_out = fopen("./src/txt_files/add_cmp.txt", "w");
    int i = 0;
    for ( i = 0; i < n_samples; i++ )
    {
...
{
    FILE * sub_out = fopen("./src/txt_files/sub_cmp.txt", "w");
    int i = 0;
    for ( i = 0; i < n_samples; i++ )
    {
        output[i] = x_in[i] - y_in[i];
